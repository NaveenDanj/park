...
<!-- 
    ...
    <center><h3 style="font-family: Roboto; font-size : 25px; margin-top : 10px; font-weight : bold; ">"Vergeet niet bij het uit dienst gaan je status up te date naar uit dienst" - Brahim </h3></center>
  </div>
</template>
